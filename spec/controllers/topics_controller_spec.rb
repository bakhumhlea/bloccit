...
RSpec.describe TopicsController, type: :controller do
    ...
    context "guest" do
        #note1: guest menber only view index view and show topic view
        ...
        #note2: when guest user request GET new view, try to POST create, 
        #GET to edit view, try to PUT update and try to DELETE destroy topic.
        #It will redirect to 'new_session_path', ask user to sign up.
        describe "GET new" do
    ...
    #end of user member context spec
...
#end of user admin (the original spec one)